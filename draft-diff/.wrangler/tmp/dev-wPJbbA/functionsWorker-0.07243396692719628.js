...
// .wrangler/tmp/bundle-1y5FjR/checked-fetch.js
...
// .wrangler/tmp/bundle-1y5FjR/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-TzIF9K/functionsWorker-0.07243396692719628.mjs
...
__name(json, "json");
__name2(json, "json");
var ok = /* @__PURE__ */ __name2((d) => json({ success: true, data: d }), "ok");
var fail = /* @__PURE__ */ __name2((m, c = 400) => json({ success: false, error: m }, { status: c }), "fail");
...
__name2(json2, "json");
function ok2(data) {
  return json2({ success: true, data });
}
__name(ok2, "ok2");
__name2(ok2, "ok");
function fail2(msg, code = 400) {
  return json2({ success: false, error: msg }, { status: code });
}
__name(fail2, "fail2");
__name2(fail2, "fail");
...
async function onRequestGet2(context) {
  ...
  try {
    ...
    const data = results.map((r) => ({
      ...r,
      tags: safeParseJSON2(r.tags, [])
    }));
    return ok2(data);
  } catch (e) {
    return fail2("\u67E5\u8BE2\u5931\u8D25: " + e.message, 500);
  }
}
...
async function onRequestPost(context) {
  ...
  if (isBulk) {
    ...
    for (const a of body.articles) {
      const wordCount2 = (a.content || "").replace(/\s/g, "").length;
    ...
    return ok2({ inserted: results.length, ids: results });
  }
  if (!body.title || !body.content) {
    return fail2("\u6807\u9898\u548C\u5185\u5BB9\u4E0D\u80FD\u4E3A\u7A7A");
  }
  const now = Date.now();
  const wordCount = (body.content || "").replace(/\s/g, "").length;
  try {
    ...
    return fail2("\u4FDD\u5B58\u5931\u8D25: " + e.message, 500);
  }
}
...
__name2(safeParseJSON2, "safeParseJSON");
...
__name(json3, "json3");
__name2(json3, "json");
var ok3 = /* @__PURE__ */ __name2((d) => json3({ success: true, data: d }), "ok");
...
async function onRequestGet3(context) {
  ...
  try {
    ...
    return json3({ success: false, error: e.message }, { status: 500 });
  }
}
...
// .wrangler/tmp/bundle-1y5FjR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-1y5FjR/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.07243396692719628.js.map
